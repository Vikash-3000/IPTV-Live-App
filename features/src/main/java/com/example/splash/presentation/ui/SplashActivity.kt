package com.example.splash.presentation.ui
...
class SplashActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val ACTIVITY_TRANSITION_DELAY = 1230L
    }
        ...
        lottieView.addAnimatorListener(
            object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    val scaleUpX = PropertyValuesHolder.ofFloat(
                        View.SCALE_X,
                        1f,
                        LOTTIE_ANIMATION_SCALE_UP_FACTOR
                    )
                    val scaleUpY = PropertyValuesHolder.ofFloat(
                        View.SCALE_Y,
                        1f,
                        LOTTIE_ANIMATION_SCALE_UP_FACTOR
                    )
                    ...
                    val scaleAnim =
                        ObjectAnimator.ofPropertyValuesHolder(lottieView, scaleUpX, scaleUpY)
                            .apply {
                                duration =
                                    LOTTIE_ANIMATION_SCALE_DURATION // Faster for snappier feel
