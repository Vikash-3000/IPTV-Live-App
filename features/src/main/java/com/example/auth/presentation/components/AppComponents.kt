...
import theme.BgSocial
import theme.BorderColor
import theme.BrandColor
import theme.Primary
import theme.Tertirary
...
fun AppNameTextComponent(heading: String) {
    Text(
        ...
        fontFamily = FontFamily(Font(com.example.livetvapp.commons.R.font.poppins_bold))
    )
}
...
fun BottomLoginTextComponent(
    initialText: String, action: String, navController: NavHostController
) {
    ...
    @Suppress("DEPRECATION") ClickableText(text = annotatedString, onClick = {
