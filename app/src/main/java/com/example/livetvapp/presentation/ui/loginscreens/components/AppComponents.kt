package com.example.livetvapp.presentation.ui.loginscreens.components
...
import com.example.livetvapp.ui.theme.BgSocial
import com.example.livetvapp.ui.theme.BorderColor
import com.example.livetvapp.ui.theme.BrandColor
import com.example.livetvapp.ui.theme.Primary
import com.example.livetvapp.ui.theme.Tertirary
...
@Composable
fun AppNameTextComponent(heading: String) {
    Text(
        text = heading,
...
fun SignupTermsAndPrivacyText() {
    val initialText = "By continuing, you agree to the "
    val termsNConditionText = "Terms & Conditions"
    val andText = " and "
    val privacyPolicyText = "Privacy Policy."
    val lastText = " Your experience and privacy are our priority."
...
fun BottomSignupTextComponent(navController: NavHostController) {
    ...
    val lastText = " to continue watching your favorite shows and channels."
